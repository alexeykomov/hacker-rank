...
def get_rose_of_points(grid, source_point):
    rose_of_points = []
...
def find_shortest_path(grid, start_x, start_y, goal_x, goal_y):
    ...
    while len(points_to_visit):
        ...
        rose_of_points = get_rose_of_points(grid, source_point)
        ...
        for point in rose_of_points:
            if grid[point.x][point.y] == '.':
                ...
                if point.x == goal_x and point.x == goal_y:
...
if __name__ == '__main__':
    ...
    result = find_shortest_path(grid, start_x, start_y, goal_x, goal_y)
